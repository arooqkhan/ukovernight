                ...
                <div class="col-md-12">
                    <div class="form-group-wrapper">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" class="form-control" id="inputName" name="name" placeholder="Enter Expense Name" value="{{ old('name') }}" maxlength="255" required>
                        </div>
                        @if ($errors->has('name'))
                ...
                <div class="col-md-6">
                    <div class="form-group-wrapper">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="number" step="0.01" class="form-control" id="inputPrice" name="price" placeholder="Enter Price" value="{{ old('price') }}" min="0" max="99999999" required>
                    </div>
                        @if ($errors->has('price'))
                ...
                <div class="col-md-6">
                    <div class="form-group-wrapper">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="date" class="form-control" id="inputDate" name="date" value="{{ old('date') ? old('date') : date('Y-m-d') }}" max="{{ date('Y-m-d') }}" required>
                        </div>
                        @if ($errors->has('date'))
