        ...
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    <span class="page-link" aria-hidden="true" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; border-color: #667eea !important; color: #ffffff !important; font-size: 1.4rem !important; font-weight: 700 !important; opacity: 0.5;">&lt;</span>
                </li>
            @else
                <li class="page-item">
